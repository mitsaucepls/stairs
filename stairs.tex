...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{./resources/StairGamba.png}
    \caption{Gambling with Incentives}
    \label{fig:gamba}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{./resources/StairImgAI.png}
    \caption{AI Image Generation with Grandmas falling down Stairs}
    \label{fig:imgai}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{./resources/StairStats.png}
    \caption{Stair Statboard}
    \label{fig:statboard}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{./resources/StairNewspaper.png}
    \caption{Newspaper with Theme Slider}
    \label{fig:newspaper}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{./resources/StairTikTokBrain.png}
    \caption{TikTok Videos with Headline}
    \label{fig:tiktokbrain}
\end{figure}
